...
pipe=pickle.load(open('pipe.pkl\IPL.pkl', 'rb'))
...
if st.button("Predict Probability"):
    ...
    input_df=pd.DataFrame({'batting_team':[batting_team],'bowling_team':[balling_team],
    ...
    st.text(balling_team + "-" + str(round(loss*100)) + "%")
